...
| 6  | `--delete`                | Eintrag nach ID löschen (`filter (\r -> id r /= givenID)`)                                          | 2h      | Marco          | Nr 4         | Mehrfach-Delete, Undo        | ja in main|
| 7  | `--filter`                | Filtern nach Wert (`filter (\r -> value r > x)`)                                                    | 2h      | Gary           | Nr 4         | Regex-Filter, Range-Filter   | ja in main|
